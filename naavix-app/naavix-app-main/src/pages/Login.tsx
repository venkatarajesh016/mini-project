  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-naavix-orange/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-naavix-purple/20 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md relative fade-in-up">
        ...
        <div className="glass-card rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to continue to Naavix</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl text-lg font-semibold btn-gradient border-0"
            >
              Sign In
            </Button>
          </form>
